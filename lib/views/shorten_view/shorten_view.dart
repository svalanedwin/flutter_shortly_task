...
import 'package:flutter_shorlty_task/views/shorten_view/widgets/history_widget.dart';
...
class ShortenView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
                    ...
                    Column(
                        ...
                        children: [
                          ...
                          ?ShortenEmptyHistoryWidget(
                              ...
                              description: localization.letsGetStartedDescription.tr,
                              ...
                              child: ListView.builder(
                                  ...
                                  itemBuilder: (BuildContext context, int index){
                                      return HistoryWidget(
                                          lastUrl: controller.historyList[index].lastUrl,
                                          shortenUrl: controller.historyList[index].shortenUrl,
    ...
    child: SvgPicture.asset(assets.shapeSvg,alignment: Alignment.topRight),
    ),
    Padding(
